...
faile to find a satisfactory optimum.
...
that are NOT in the default set will cause these to be passed to the relevant 
...
in supplied function, gradient or hessian functions. Though we do 
not yet use hessians in the optimizers called, it is hoped that
